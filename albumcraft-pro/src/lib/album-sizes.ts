...
// Templates padronizados para criação em lote
export interface AlbumTemplate {
  ...
  sizeId: string
  pages: number
  template: 'classic' | 'modern' | 'artistic' | 'minimal'
}

export const ALBUM_TEMPLATES: AlbumTemplate[] = [
  {
    id: 'classic-20x20',
    name: 'Clássico 20x20cm',
    description: 'Formato quadrado ideal para eventos',
    sizeId: 'SIZE_20X20',
    pages: 20,
    template: 'classic'
  },
  {
    id: 'classic-30x20',
    name: 'Clássico 30x20cm',
    description: 'Formato paisagem clássico',
    sizeId: 'SIZE_30X20',
    pages: 24,
    template: 'classic'
  },
  {
    id: 'modern-20x20',
    name: 'Moderno 20x20cm',
    description: 'Design moderno quadrado',
    sizeId: 'SIZE_20X20',
    pages: 20,
    template: 'modern'
  },
  {
    id: 'modern-30x20',
    name: 'Moderno 30x20cm',
    description: 'Design moderno paisagem',
    sizeId: 'SIZE_30X20',
    pages: 24,
    template: 'modern'
  },
  {
    id: 'premium-30x30',
    name: 'Premium 30x30cm',
    description: 'Formato premium quadrado grande',
    sizeId: 'SIZE_30X30',
    pages: 32,
    template: 'artistic'
  },
  {
    id: 'premium-20x30',
    name: 'Premium 20x30cm',
    description: 'Formato premium retrato',
    sizeId: 'SIZE_20X30',
    pages: 28,
    template: 'artistic'
  },
  ...
  },
  {
    id: 'deluxe-40x30',
    name: 'Deluxe 40x30cm',
    description: 'Formato profissional grande',
    sizeId: 'SIZE_40X30',
    pages: 40,
    template: 'artistic'
  }
...
export const getTemplateById = (id: string): AlbumTemplate | undefined => {
  return ALBUM_TEMPLATES.find(template => template.id === id)
}

export const getTemplatesBySize = (sizeId: string): AlbumTemplate[] => {
  return ALBUM_TEMPLATES.filter(template => template.sizeId === sizeId)
}